# Email in Database (count up the number email messages per organization)
...
count up the number email messages per organization (i.e. domain name of the email address) using a database with the following schema to maintain the counts.
